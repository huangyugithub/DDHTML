...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath }/keyCode?user.user_id=${requestScope.user.user_id}" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess">
						...
						<input name="user.user_ukey" type="text" id="validatecode" class="yzm_text" />
