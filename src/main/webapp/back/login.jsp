...
<body>
	...
	<div class="login_bg" style="width:960px; margin:0 auto;">
		...
		<br/><br/>
		<div style="color:red;float:right"><h1 style="font-size:30px">${sessionScope.hint}</h1></div>
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath }/code" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
										<a id="vcodeImgBtn" name="change_code_link" class="code_picww"  onClick="document.getElementById('imgVcode').src='${pageContext.request.contextPath}/code?dt='+(new Date()).getTime()">换张图</a> 
